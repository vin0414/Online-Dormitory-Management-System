            ...
            <ul class="sidebar-menu">
                ...
                <li class="active treeview">
                    <a class="waves-effect waves-dark" href="javascript:void(0);">
                        <i class="icofont icofont-envelope"></i><span> View Message</span>
                    </a>                
                </li>
            </ul>
         </section>
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-block">
                            ...
                            {
                                $id = $_GET['id'];
                                $sql = "Select a.*,b.Fullname from tblfeedback a LEFT JOIN tblcustomer b ON b.customerID=a.customerID WHERE a.feedID=:id";
                                ...
                                foreach($data as $row)
                                {
                                    $file = "../feedback/".$row['File'];
                                    ?>
                                    <div class="card-header-text">Subject : <?php echo $row['Subject'] ?></div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 form-group">
                                                    <label>Details</label>
                                                    <textarea class="form-control" style="height:200px;overflow-y:auto;"><?php echo $row['Details'] ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12 form-group">
                                            <a href="../resources/attachment.php?filename=<?php echo $file?>&f=<?php echo $row['File'] ?>" class="btn btn-link"><?php echo $row['File'] ?></a>
                                        </div>
                                    </div>
                                    <?php
                                }

            ...
            <ul class="sidebar-menu">
                ...
                <li class="active treeview">
                    <a class="waves-effect waves-dark" href="javascript:void(0);">
                        <i class="icofont icofont-user"></i><span> Customer Information</span>
                    </a>                
                </li>
                <li class="treeview">
         ...
         <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-header-text">Trxn No. <?php echo $trxn; ?></div>
                </div>
                <div class="card-block">
                    <?php
                    try
                    {
                        $sql = "Select d.Fullname,a.*,FORMAT(a.TotalRate,2)charge,b.RoomNumber,c.Name,c.Description,FORMAT(c.Rate,2)Rate,d.* from tbltransaction a LEFT JOIN tblavailableroom b ON a.aID=b.aID 
            LEFT JOIN tblrooms c ON c.roomID=b.roomID LEFT JOIN tblcustomer d ON a.customerID=d.customerID WHERE a.Remarks='UnPaid' AND a.trxnID=:id";
                        ...
                        <form method="POST" class="row">
                            ...
                            <input type="hidden" name="aID" id="aID" value="<?php echo $trxn; ?>"/>
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 form-group">
                                        ...
                                        <input type="text" class="form-control" name="room_name" value="<?php echo $row['Name'] ?>"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <label>Description</label>
                                <textarea class="form-control" style="height:120px;overflow-y:auto;"><?php echo $row['Description'] ?></textarea>
                            </div>
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-lg-2 form-group">
                                        <label>Room No.</label>
                                        <input type="text" class="form-control" name="room_number" value="<?php echo $row['RoomNumber'] ?>"/>
                                    </div>
                                    <div class="col-lg-3 form-group">
                                        <label>Room Rate</label>
                                        <input type="text" class="form-control" name="rate" value="<?php echo $row['Rate'] ?>" style="text-align:right;"/>
                                    </div>
                                    <div class="col-lg-2 form-group">
                                        <label>From Date</label>
                                        <input type="date" class="form-control" name="fromdate" value="<?php echo $row['FromDate'] ?>"/>
                                    </div>
                                    <div class="col-lg-2 form-group">
                                        <label>To Date</label>
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <input type="text" class="form-control" id="total_charge" name="total_charge" value="<?php echo $row['charge'] ?>"  style="text-align:right;"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
    ...
    $('#btnSave').on('click',function(evt)
    {
        ...
        $.ajax({
            ...
            success:function(data)
            {
                if(data==="success")
                {
                    alert("Successfully saved! Please proceed to billing");
                    window.location.href="billing.php?transaction="+id;
                }
                else
                {
                    alert(data);

...
<body class="sidebar-mini fixed">
   ...
   <script src="../assets/js/menu.min.js"></script>
    ...
    $(document).ready(function()
    {
       ...
       {
           var confirmation = confirm("Accept the reservation?");
           if(confirmation)
           {
               var val = $(this).val();
               window.location.href="customer-details.php?trxn="+val;
           }
           
       });
       $(document).on('click','.ignore',function()
       {
           var confirmation = confirm("Do you want to cancel the reservation?");
           if(confirmation)
           {
               var val = $(this).val();
               var action = "cancel";
    ...
    {
        $('#tblcustomer').html("<tr><td colspan='8'><center>Loading Records...</center></td></tr>");
        ...
        $.ajax({
            ...
            {
                if(data===""){
                    $('#tblcustomer').html("<tr><td colspan='8'><center>No Reservation(s)</center></td></tr>");
                }
                else
                {
    ...
    {
        $('#tblcustomer').html("<tr><td colspan='8'><center>Searching Records...</center></td></tr>");
        var action = "search-reservation";
        var text = $(this).val();
        $.ajax({
            url:"../resources/employee.php",method:"POST",
